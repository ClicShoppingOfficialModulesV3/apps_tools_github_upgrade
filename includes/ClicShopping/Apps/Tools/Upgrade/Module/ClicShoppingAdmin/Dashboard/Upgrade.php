  ...
  class Upgrade extends \ClicShopping\OM\Modules\AdminDashboardAbstract {
    ...
    public function getOutput() {
      ...
      if ($new_version === true) {
        ...
        $output .= '<span class="col-md-4 text-md-right">' . HTML::button($this->app->getDef('module_admin_dashboard_clicshopping_update_app_button'), null, CLICSHOPPING::link('CLICSHOPPING::link(null, 'A&Tools\Upgrade&Upgrade'), 'secondary', null, 'sm') . '</span>';
        $output .= '</div>';
        $output .= '</div>';
