...
<?php
          ...
          if (strtolower($item->type) == 'apps') {
            $module = CLICSHOPPING::link('CLICSHOPPING::link(null, 'A&' . $item->module_directory . '\\' . $item->apps_name);
          } else {
...
<?php
            ...
            if (strtolower($result_content_module->type) == 'apps') {
              $module = CLICSHOPPING::link('CLICSHOPPING::link(null, 'A&' . $result_content_module->module_directory . '\\' . $result_content_module->apps_name);
            } else {
